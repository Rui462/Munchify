...
<nav id='main_nav' class="fixed-top navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
	  ...
	  <li class="nav-item">
        <a href='termek_kezeles' class="nav-link" style='color: white; white-space: nowrap;'>Termék kezelés</a>
        
      </li>
      <li class="nav-item">
      <a href='admin.php' class="nav-link" style='color: white; white-space: nowrap;'>Felhasználó kezelés</a>
