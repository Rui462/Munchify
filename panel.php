...
<head>
    ...
    <title>Munchify | Eladói felület</title>
</head>
<body>
<div id='rendelesakt'>
</div>
...
<div id='betoltokepernyo' class='betoltokepernyo' style='z-index:999;'> 
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner" >
          <div class="carousel-item active" style='height: 5em;'>
            <img src="./img/szenya1.jpg" class="topKep d-block w-100" alt="...">
            <div class="carousel-caption">
                <h1 style='font-size: 3vw;'>MUNCHIFY - ELADÓ PANEL</h1>
              </div>
          </div>
        </div>
      </div>
    ...
    <div class="container" style='z-index: 1;'>
        <div class="row">
          <div class="col-sm">
            <p class="felkapottak">Aktív rendelések:</p>

          </div>
        </div>
        <div class='rendelesek' id='rendelesek' style='z-index: 1;'>
    ...
    <script src='js/rendeles_listazas.js'></script>
