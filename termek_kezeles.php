    ...
    <div class="container">
        <div class="row">
              <div class="col-sm">
                ...
                <input type='text' id='termeknev' placeholder='Termék neve...' style='padding: 0.3em; outline: none;'/><button onClick='termekkereses()' style='border: 1px solid #306e21; outline: none; background-color: #306e21; color: white; padding: 0.3em;'>Keresés</button>
              </div>
            </div>
        <hr>
        <div class="row">
          <div class="col-sm">
            ...
            <form enctype="multipart/form-data" method='POST'>
                ...
                <div style='padding-top: 0.3em;'></div>
                <input type='submit' name='feltoltve' onClick='termekhozzaadas()' style='border: 1px solid #306e21; outline: none; background-color: #306e21; color: white; padding: 0.3em; width: 100%; box-sizing: border-box;'/>
            </form>  
          </div>
        </div>
        <hr>
