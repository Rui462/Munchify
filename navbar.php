...
<nav id='main_nav' class="fixed-top navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="home"><img id="navkep" src="/img/munchify_logo1.png" alt=""></a>
  <form method='POST' >
      <input class="form-control mr-sm-2" type="text" placeholder="Keresés" id='keresomezo' name="keres"></input>
	 </form>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
	  ...
	  <li class="nav-item">
        <a href='kosar' class="nav-link" style='color: white; white-space: nowrap;' href="#">Kosár (<span id='kosardarab'></span>)</a>
      </li>
    ...
    <a style="color:#498bf5;"class="dropdown-item disabled" href="#">Rangod: <?php echo $_SESSION["rang"];?></a>
		<div class="dropdown-divider"></div>
          <a class="dropdown-item" href="usersettings">Fiókadatok</a>
          <a class="dropdown-item" href="korabbrend.php">Korábbi rendeléseim</a>
          <div class="dropdown-divider"></div>
...
<?php
  if(isset($_POST["keres"])){
    $kereses = $_POST["keres"];
    header("Location: kereses.php?k=$kereses");
  }
?>