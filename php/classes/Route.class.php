...
class Route
{
    ...
    public function urlRoute()
    {
        switch (end($this->url))
        {
            ...
            case 'listazaskeres' :
                $user = new Query();
                echo $user->listazasKeres(
                    $this->erkezettAdatok->kereses
                );
                break;
            ...
            case 'opciolistazas' :
                $user = new Query();
                echo $user->opcioBetoltes(
                    $this->erkezettAdatok->szunet
                );
                break;
            case 'termekkeres' :
                $user = new Query();
                echo $user->termekKeres(
                    $this->erkezettAdatok->kereses
                );
                break;
            case 'szunetbetoltes' :
                $user = new Query();
                echo $user->szunetBetoltes();
                break;
            case 'szunetmentes' :
                $user = new Query();
                echo $user->szunetMentes(
                    $this->erkezettAdatok->szunet,
                    $this->erkezettAdatok->ujido
                );
                break;
            ...
            case 'termektorles' : 
                $user = new Query();
                echo $user->termekTorles(
                    $this->erkezettAdatok->id
                );
                break;
            case 'kategoriainfok' : 
                $user = new Query();
                echo $user->kategoriaInfok(
                    $this->erkezettAdatok->id
                );
                break;
